        ...
        <div class="container mx-auto px-6">
            ...
            <div class="max-w-4xl">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-slate-500 text-xs font-bold"><i class="fa fa-star text-amber-500 mr-1"></i> 4.9 ({{ rand(80, 200) }} Reviews)</span>
                </div>
            ...
            <div class="lg:col-span-8 space-y-10">
                ...
                <div class="content-card p-10 grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-black text-slate-900">Adaptive</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Language</p>
                        <p class="text-lg font-black text-slate-900">Eng/Hindi</p>
                    </div>
                    <div>
                    ...
                    <div class="enroll-action-card p-10">
                        ...
                        <div class="space-y-4 mb-10">
                            @auth
                                ...
                                @endif
                            @else
                                <a href="{{ route('student.login') }}" class="btn-enroll bg-slate-900 hover:bg-black">
                                    Login to Purchase
                                </a>
                            @endauth
                        </div>
