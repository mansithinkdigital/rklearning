...
<div class="max-w-6xl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div class="card bg-slate-900 text-white border-none p-8">
            ...
            <div class="text-3xl font-bold font-Outfit">INR 12,000</div>
        </div>
        <div class="card bg-emerald-600 text-white border-none p-8">
            ...
            <div class="text-3xl font-bold font-Outfit">INR 8,000</div>
        </div>
        <div class="card bg-white border-slate-200 p-8 shadow-sm">
            ...
            <div class="text-3xl font-bold font-Outfit text-red-600">INR 4,000</div>
        </div>
    </div>
    ...
    <div class="card !p-0 overflow-hidden shadow-sm">
        <div class="p-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
            ...
            <button class="text-xs font-bold text-blue-600 px-4 py-2 bg-blue-50 rounded-lg hover:bg-blue-100 transition">Contact Accounts</button>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    <tr class="hover:bg-slate-50/50 transition">
                        <td class="px-8 py-6 font-mono text-xs text-slate-500">RK-PAY-45920</td>
                        <td class="px-8 py-6">
                            <p class="text-sm font-bold text-slate-800">Admission Fee + Term 1</p>
                            <p class="text-[10px] text-slate-500 font-medium">Professional Tally Prime</p>
                        </td>
                        <td class="px-8 py-6">
                            <span class="px-3 py-1 bg-slate-100 rounded-full text-[10px] font-bold text-slate-600">OFFLINE</span>
                        </td>
                        <td class="px-8 py-6 text-sm text-slate-600">12 Feb, 2026</td>
                        <td class="px-8 py-6 font-bold text-slate-900">INR 5,500</td>
                        <td class="px-8 py-6 text-center">
                            <a href="#" class="inline-flex items-center justify-center w-10 h-10 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-600 hover:text-white transition shadow-sm">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        <td class="px-8 py-6 font-mono text-xs text-slate-500">RK-PAY-46812</td>
                        <td class="px-8 py-6">
                            <p class="text-sm font-bold text-slate-800">Monthly Installment - March</p>
                            <p class="text-[10px] text-slate-500 font-medium">Professional Tally Prime</p>
                        </td>
                        <td class="px-8 py-6">
                            <span class="px-3 py-1 bg-indigo-100 rounded-full text-[10px] font-bold text-indigo-600">ONLINE</span>
                        </td>
                        <td class="px-8 py-6 text-sm text-slate-600">05 Mar, 2026</td>
                        <td class="px-8 py-6 font-bold text-slate-900">INR 2,500</td>
                        <td class="px-8 py-6 text-center">
                            <a href="#" class="inline-flex items-center justify-center w-10 h-10 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-600 hover:text-white transition shadow-sm">
                                <i data-lucide="download" class="w-5 h-5"></i>
                            </a>
